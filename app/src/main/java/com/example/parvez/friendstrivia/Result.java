...
public class Result extends Activity {
    ...
    TextView tv;
    Button btnRestart, share, twitter_button, fb_button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logoMusic = MediaPlayer.create(Result.this, R.raw.result);
        logoMusic.start();
        ...
        sb.append(question.marks);


        tv.setText(sb);
        if (question.correct == 10) {
            Toast.makeText(getApplicationContext(), "Perfect! Could you be Anymore Awesome?",
                    Toast.LENGTH_LONG).show();
        } else
            Toast.makeText(getApplicationContext(), "Correct: " + question.correct + " Wrong: " + question.wrong,
                    Toast.LENGTH_LONG).show();
        ...
        fb_button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                String urlToShare = "http://www.funvsfun.org/8unknownfacts.html";
        ...
        twitter_button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                tweetIntent.putExtra(Intent.EXTRA_TEXT, "Check Out This Awesome Friends Trivia App!");
